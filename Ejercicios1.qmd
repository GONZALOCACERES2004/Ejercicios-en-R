...
smoker <- bwt$smoker
smoker_factor <- as.factor(smoker)
plot(smoker_factor, bwt$Birthweight, xlab = "Smokers", ylab = "Birthweight")

ggplot(data=bwt,aes(x=smoker, y=Birthweight,color=smoker))+geom_boxplot()+
   scale_color_discrete(name="Fumadoras")+  xlab('Fumadora')+ylab('Peso')+
  ggtitle("Birthweight ", subtitle = "smoker")
...
#df_sunny[df_sunny$q1==max(df_sunny$q1), c("Country","City")]
